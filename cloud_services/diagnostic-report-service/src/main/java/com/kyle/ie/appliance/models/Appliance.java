...
public class Appliance {
	...
	private String dryingPerformanceClass;
	private String washingPerformanceClass;
	...
	@JsonInclude(Include.NON_DEFAULT)
	public String getDryingPerformanceClass() {
		return dryingPerformanceClass;
	}

	public void setDryingPerformanceClass(String dryingPerformanceClass) {
		this.dryingPerformanceClass = dryingPerformanceClass;
	}
	
	@JsonInclude(Include.NON_DEFAULT)
	public String getWashingPerformanceClass() {
		return washingPerformanceClass;
	}

	public void setWashingPerformanceClass(String washingPerformanceClass) {
	...
	@JsonInclude(Include.NON_DEFAULT)
	public String getCoolingAgent() {
		return coolingAgent;
	}

	public void setCoolingAgent(String coolingAgent) {
