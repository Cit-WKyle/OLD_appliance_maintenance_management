package com.kyle.ie.auth.security.jwt;
...
public class JwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private final ITokenExtractor _tokenExtractor;
	
	public JwtTokenAuthenticationProcessingFilter(AuthenticationFailureHandler failureHandler, 
            ITokenExtractor tokenExtractor, RequestMatcher requiresAuthenticationRequestMatcher) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        RawAccessJwtToken token = new RawAccessJwtToken(_tokenExtractor.extract(tokenPayload));
